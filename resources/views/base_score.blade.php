...
@section('content')
    <div class="row">
        <p class="col-xs-4 text-info">Base Strength (or base score) is a value used by the game in matchmaking. This
            table shows how much each building of each level contributes to your base strength value.</p>
